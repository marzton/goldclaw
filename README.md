...
- `docs/` - Cross-repo ops docs: `business-plan.md`, `integration-map.md` (master goldshore.ai/.org integration map), `cf-infrastructure.md`, `secrets-map.md`, `repo-index.md`, `open-work.md`, plus OpenClaw scaling notes, migration references, and implementation templates.
